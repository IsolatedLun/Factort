<script lang="ts">
	...
	onMount(() => {
		_this.addEventListener('mouseenter', () => (show = true));
		_this.addEventListener('mouseleave', () => (show = false));
	});
...
<div class={_class} bind:this={_this}>
	...
	{#if workCondition && (explicitShow || show)}
		<div class="[ lol z-index-999 ]" transition:fade>
			<Card
